...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(/*! /Users/joshuafang/Desktop/Aquaforces/http/game/game_components.jsx */1);
	module.exports = __webpack_require__(/*! /Users/joshuafang/Desktop/Aquaforces/http/game/game.jsx */39);
...
/***/ function(module, exports, __webpack_require__) {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'panel-top' },
						_react2.default.createElement(GameTimer, { onFinish: this.gameTimerOver, totalTime: 900000 }),
						_react2.default.createElement(Question, { text: this.state.questionText })
					),
					_react2.default.createElement(
						'div',
						{ className: 'panel-bottom' },
						_react2.default.createElement(QuestionTimebar, { onTimeout: this.questionTimeout, timePerQuestion: 10000, ref: 'questionTimebar' })
					)
				),
				_react2.default.createElement(River, {
	...
	var Answer = _react2.default.createClass({
		...
		render: function render() {
			...
			if (!this.state.disappeared) return _react2.default.createElement(
				'span',
	...
	var Canoe = _react2.default.createClass({
		displayName: 'Canoe',
		getInitialState: function getInitialState() {
			return {
				hp: 100,
	...
	var River = _react2.default.createClass({
		displayName: 'River',
		getInitialState: function getInitialState() {
			return {
				image: _react2.default.createElement('img', null)
			};
		},
		render: function render() {
			return _react2.default.createElement(
				'div',
				{ className: 'river' },
				_react2.default.createElement(Canoe, { position: this.props.position, initialImage: this.props.initialImage }),
				_react2.default.createElement(
					'div',
					{ className: 'answers' },
	...
	var QuestionTimebar = _react2.default.createClass({
		...
		render: function render() {
			...
			return _react2.default.createElement('div', { style: style, id: 'questionTime' });
		}
	});
	
	var GameTimer = _react2.default.createClass({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _game_components = __webpack_require__(/*! ./game_components.jsx */ 1);
	
	var _game_components2 = _interopRequireDefault(_game_components);
	...
	socket.onmessage = function (m) {
		...
		switch (m.event) {
			...
			case 'startGame':
				...
				answers = m.answers;
				game = _reactDom2.default.render(_react2.default.createElement(_game_components2.default, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(/*! react/lib/ReactDOM */ 41);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createMicrosoftUnsafeLocalFunction = __webpack_require__(/*! ./createMicrosoftUnsafeLocalFunction */ 82);
	var setInnerHTML = __webpack_require__(/*! ./setInnerHTML */ 85);
	var setTextContent = __webpack_require__(/*! ./setTextContent */ 83);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ExecutionEnvironment = __webpack_require__(/*! fbjs/lib/ExecutionEnvironment */ 21);
	var escapeTextContentForBrowser = __webpack_require__(/*! ./escapeTextContentForBrowser */ 84);
	var setInnerHTML = __webpack_require__(/*! ./setInnerHTML */ 85);
