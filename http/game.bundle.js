...
/***/ function(module, exports, __webpack_require__) {
	...
	var Answer = _react2.default.createClass({
		...
		setPosition: function setPosition() {
			...
			var timeSinceStart = timeAtAnimation - this.state.startTime;
			var newX = this.state.initialPosition.x + this.state.velocity.vx * timeSinceStart / 1000;
			var newY = this.state.initialPosition.y + this.state.velocity.vy * timeSinceStart / 1000;
			this.setState({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var socket = new WebSocket((location.protocol === 'http:' ? 'ws://' : 'wss://') + location.hostname + (location.port != 80 ? ':' + location.port : '') + '/game/');
	...
	function setState(id) {
		...
		cont.children.forEach(function (e) {
			var element = e;
			if (element.id !== id) element.hidden = true;
		});
