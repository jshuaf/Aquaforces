...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(/*! /Users/joshuafang/Desktop/Aquaforces/http/host/host_components.jsx */170);
	module.exports = __webpack_require__(/*! /Users/joshuafang/Desktop/Aquaforces/http/host/host.jsx */171);
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							Object.keys(this.state.crews).map(function (crewNumber, i) {
								...
								return _react2.default.createElement(Crew, { position: crew.position, status: crew.status, boat: crew.boat, crewNumber: crewNumber, key: i, ref: crewNumber.toString() });
							}.bind(this))
						)
					)
				)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _host_components = __webpack_require__(/*! ./host_components.jsx */ 170);
	
	var _host_components2 = _interopRequireDefault(_host_components);
	...
	document.getElementById('start-game-btn').addEventListener('click', function (e) {
		...
		setState('mountNode');
		gameHasStarted = true;
		gameHost = _reactDom2.default.render(_react2.default.createElement(_host_components2.default, { initialCrews: crews }), document.getElementById('mountNode'));
	});
	function endGame() {
		socket.send(JSON.stringify({
			event: 'endGame'
